    ...
    def _get_or_create_message_sheet(
        ...
        try:
            ...
            if results.get("files"):
                ...
                if (
                    "rasswanth" in sheet_name
                    and hasattr(self, "verbose")
                    and self.verbose
                ):
                    print(
                        f"   🔍 Found existing rasswanth sheet: {sheet_id}", flush=True
                    )
                return sheet_id
        ...
        if cache_key in self._sheet_id_cache:
            ...
            try:
                ...
                if "rasswanth" in sheet_name:
                    print(
                        f"   🔍 Cache hit for rasswanth sheet: {sheet_id}", flush=True
                    )
                return sheet_id
            except Exception as e:
