...
from syft_client.syncv2.connections.base_connection import ConnectionConfig
from syft_client.syncv2.connections.drive.gdrive_transport import GDriveConnection
